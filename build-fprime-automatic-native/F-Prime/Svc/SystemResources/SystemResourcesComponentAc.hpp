...
#ifndef Svc_SystemResourcesComponentAc_HPP
#define Svc_SystemResourcesComponentAc_HPP
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      virtual void ENABLE_cmdHandler(
          FwOpcodeType opCode, //!< The opcode
          U32 cmdSeq, //!< The command sequence number
          Svc::SystemResourceEnabled enable //!< whether or not system resource telemetry is enabled
      ) = 0;
