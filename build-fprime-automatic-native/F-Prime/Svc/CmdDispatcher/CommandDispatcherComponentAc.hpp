    ...
    public Fw::ActiveComponentBase
  {
    ...
    protected:
      ...
      void log_DIAGNOSTIC_OpCodeRegistered(
          FwOpcodeType Opcode, //!< The opcode to register
      ...
      void log_COMMAND_OpCodeDispatched(
          FwOpcodeType Opcode, //!< The opcode dispatched
      ...
      void log_COMMAND_OpCodeCompleted(
          FwOpcodeType Opcode //!< The I32 command argument
      ) const;
      ...
      void log_COMMAND_OpCodeError(
          FwOpcodeType Opcode, //!< The opcode with the error
      ...
      void log_WARNING_HI_InvalidCommand(
          FwOpcodeType Opcode //!< Invalid opcode
      ) const;
      ...
      void log_WARNING_HI_TooManyCommands(
          FwOpcodeType Opcode //!< The opcode that overflowed the list
      ) const;
      ...
      void log_DIAGNOSTIC_OpCodeReregistered(
          FwOpcodeType Opcode, //!< The opcode reregistered
