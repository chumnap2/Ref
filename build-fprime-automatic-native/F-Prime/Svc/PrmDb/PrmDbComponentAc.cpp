...
namespace Svc {
  ...
  FwIndexType PrmDbComponentBase ::
  ...
  FwIndexType PrmDbComponentBase ::
    getNum_getPrm_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_getPrm_InputPort));
  }
  ...
  FwIndexType PrmDbComponentBase ::
    getNum_setPrm_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_setPrm_InputPort));
  }
    ...
    log_WARNING_LO_PrmIdNotFound(FwPrmIdType Id)
  {
    ...
    if (this->m_PrmIdNotFoundThrottle >= EVENTID_PRMIDNOTFOUND_THROTTLE) {
      ...
      (void) this->m_PrmIdNotFoundThrottle.fetch_add(1);
    }
  ...
  void PrmDbComponentBase ::
    log_FATAL_PrmDbFull(FwPrmIdType Id) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
  ...
  void PrmDbComponentBase ::
    log_ACTIVITY_HI_PrmFileLoadComplete(U32 records) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
