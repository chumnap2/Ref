...
namespace Svc {
    ...
    ) const
  {
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = dirName.serializeTo(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
    ...
    ) const
  {
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = sourceFileName.serializeTo(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );

      _status = destFileName.serializeTo(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
    ...
    ) const
  {
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = fileName.serializeTo(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
    ...
    ) const
  {
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = source.serializeTo(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );

      _status = target.serializeTo(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
