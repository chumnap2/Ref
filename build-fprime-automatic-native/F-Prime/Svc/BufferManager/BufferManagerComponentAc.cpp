...
namespace Svc {
  ...
  FwIndexType BufferManagerComponentBase ::
    getNum_bufferGetCallee_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_bufferGetCallee_InputPort));
  }
    ...
    log_WARNING_HI_NoBuffsAvailable(FwSizeType size)
  {
    ...
    if (this->m_NoBuffsAvailableThrottle >= EVENTID_NOBUFFSAVAILABLE_THROTTLE) {
      ...
      (void) this->m_NoBuffsAvailableThrottle.fetch_add(1);
    }
    ...
    log_WARNING_HI_NullEmptyBuffer()
  {
    ...
    if (this->m_NullEmptyBufferThrottle >= EVENTID_NULLEMPTYBUFFER_THROTTLE) {
      ...
      (void) this->m_NullEmptyBufferThrottle.fetch_add(1);
    }
