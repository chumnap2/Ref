    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      enum {
        ...
        EVENTID_NULLEMPTYBUFFER = 0x1, //!< The buffer manager received a null pointer and zero-sized buffer as a return. Probably undetected failed buffer allocation
      };
      ...
      enum {
        ...
        EVENTID_NULLEMPTYBUFFER_THROTTLE = 10, //!< Throttle reset count for NullEmptyBuffer
      };
    ...
    private:
      ...
      std::atomic<FwIndexType> m_NoBuffsAvailableThrottle;

      //! Throttle for NullEmptyBuffer
      std::atomic<FwIndexType> m_NullEmptyBufferThrottle;
