...
namespace Svc {
  ...
  FwIndexType ComQueueComponentBase ::
    getNum_bufferQueueIn_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_bufferQueueIn_InputPort));
  }

  FwIndexType ComQueueComponentBase ::
    getNum_comPacketQueueIn_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_comPacketQueueIn_InputPort));
  }
  ...
  FwIndexType ComQueueComponentBase ::
    getNum_bufferReturnOut_OutputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_bufferReturnOut_OutputPort));
  }
