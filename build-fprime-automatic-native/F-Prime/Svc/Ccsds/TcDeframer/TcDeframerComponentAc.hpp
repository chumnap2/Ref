// ======================================================================
// \title  TcDeframerComponentAc.hpp
// \author Generated by fpp-to-cpp
// \brief  hpp file for TcDeframer component base class
// ======================================================================

#ifndef Svc_Ccsds_TcDeframerComponentAc_HPP
#define Svc_Ccsds_TcDeframerComponentAc_HPP
...
namespace Svc {
  ...
  namespace Ccsds {
    ...
    //! \brief Auto-generated base for TcDeframer component
    //!
      ...
      public Fw::PassiveComponentBase
    {
      ...
      protected:
        ...
        //! Event IDs
        enum {
          EVENTID_INVALIDSPACECRAFTID = 0x0, //!< Deframing received an invalid SCID
          EVENTID_INVALIDFRAMELENGTH = 0x1, //!< Deframing received an invalid frame length
          EVENTID_INVALIDVCID = 0x2, //!< Deframing received an invalid VCID
          EVENTID_INVALIDCRC = 0x3, //!< Deframing received an invalid checksum
        };
      ...
      protected:
        ...
        //! Log event InvalidSpacecraftId
        //!
        //! Deframing received an invalid SCID
        void log_WARNING_LO_InvalidSpacecraftId(
            U16 transmitted,
            U16 configured
        ) const;

        //! Log event InvalidFrameLength
        //!
        //! Deframing received an invalid frame length
        void log_WARNING_HI_InvalidFrameLength(
            U16 transmitted,
            FwSizeType actual
        ) const;

        //! Log event InvalidVcId
        //!
        //! Deframing received an invalid VCID
        void log_ACTIVITY_LO_InvalidVcId(
            U16 transmitted,
            U16 configured
        ) const;

        //! Log event InvalidCrc
        //!
        //! Deframing received an invalid checksum
        void log_WARNING_HI_InvalidCrc(
            U16 transmitted,
            U16 computed
        ) const;
