// ======================================================================
// \title  SpacePacketDeframerComponentAc.hpp
// \author Generated by fpp-to-cpp
// \brief  hpp file for SpacePacketDeframer component base class
// ======================================================================

#ifndef Svc_Ccsds_SpacePacketDeframerComponentAc_HPP
#define Svc_Ccsds_SpacePacketDeframerComponentAc_HPP
...
namespace Svc {
  ...
  namespace Ccsds {
    ...
    //! \brief Auto-generated base for SpacePacketDeframer component
    //!
      ...
      public Fw::PassiveComponentBase
    {
      ...
      protected:
        ...
        enum {
          ...
          NUM_VALIDATEAPIDSEQCOUNT_OUTPUT_PORTS = 1,
        };

        //! Event IDs
        enum {
          EVENTID_INVALIDLENGTH = 0x0, //!< Deframing received an invalid frame length
        };
      ...
      public:
        ...
        void set_validateApidSeqCount_OutputPort(
            FwIndexType portNum, //!< The port number
      ...
      protected:
        ...
        //! Get the number of validateApidSeqCount output ports
        //!
        //! \return The number of validateApidSeqCount output ports
      ...
      protected:
        ...
        //! Check whether port validateApidSeqCount is connected
        //!
        //! \return Whether port validateApidSeqCount is connected
        bool isConnected_validateApidSeqCount_OutputPort(
            FwIndexType portNum //!< The port number
        );
      ...
      protected:
        ...
        //! Log event InvalidLength
        //!
        //! Deframing received an invalid frame length
        void log_WARNING_HI_InvalidLength(
            U16 transmitted,
            FwSizeType actual
        ) const;
      ...
      private:
        ...
        //! Output port validateApidSeqCount
        Svc::Ccsds::OutputApidSequenceCountPort m_validateApidSeqCount_OutputPort[NUM_VALIDATEAPIDSEQCOUNT_OUTPUT_PORTS];
