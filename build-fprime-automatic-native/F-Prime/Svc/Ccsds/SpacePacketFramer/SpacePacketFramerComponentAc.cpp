// ======================================================================
// \title  SpacePacketFramerComponentAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for SpacePacketFramer component base class
// ======================================================================
...
namespace Svc {
  ...
  namespace Ccsds {
    ...
    void SpacePacketFramerComponentBase ::
      init(FwEnumStoreType instance)
    {
      ...
      // Connect output port getApidSeqCount
      for (
        FwIndexType port = 0;
        port < static_cast<FwIndexType>(this->getNum_getApidSeqCount_OutputPorts());
        port++
      ) {
        this->m_getApidSeqCount_OutputPort[port].init();

#if FW_OBJECT_NAMES == 1
        Fw::ObjectName portName;
        portName.format(
          "%s_getApidSeqCount_OutputPort[%" PRI_FwIndexType "]",
          this->m_objName.toChar(),
          port
        );
        this->m_getApidSeqCount_OutputPort[port].setObjName(portName.toChar());
#endif
      }
    }
    ...
    Fw::InputSuccessConditionPort* SpacePacketFramerComponentBase ::
    ...
    Svc::InputComDataWithContextPort* SpacePacketFramerComponentBase ::
    ...
    void SpacePacketFramerComponentBase ::
      set_getApidSeqCount_OutputPort(
          FwIndexType portNum,
          Svc::Ccsds::InputApidSequenceCountPort* port
      )
    {
      FW_ASSERT(
        (0 <= portNum) && (portNum < this->getNum_getApidSeqCount_OutputPorts()),
        static_cast<FwAssertArgType>(portNum)
      );

      this->m_getApidSeqCount_OutputPort[portNum].addCallPort(port);
    }
    ...
    FwIndexType SpacePacketFramerComponentBase ::
    ...
    FwIndexType SpacePacketFramerComponentBase ::
      getNum_getApidSeqCount_OutputPorts() const
    {
      return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_getApidSeqCount_OutputPort));
    }
    ...
    bool SpacePacketFramerComponentBase ::
    ...
    bool SpacePacketFramerComponentBase ::
      isConnected_getApidSeqCount_OutputPort(FwIndexType portNum)
    {
      FW_ASSERT(
        (0 <= portNum) && (portNum < this->getNum_getApidSeqCount_OutputPorts()),
        static_cast<FwAssertArgType>(portNum)
      ...
      return this->m_getApidSeqCount_OutputPort[portNum].isConnected();
    }
    ...
    Fw::Buffer SpacePacketFramerComponentBase ::
      bufferAllocate_out(
          FwIndexType portNum,
          FwSizeType size
      )
    ...
    U16 SpacePacketFramerComponentBase ::
      getApidSeqCount_out(
          FwIndexType portNum,
      ...
      )
    {
      ...
      FW_ASSERT(
        this->m_getApidSeqCount_OutputPort[portNum].isConnected(),
        static_cast<FwAssertArgType>(portNum)
      );
      return this->m_getApidSeqCount_OutputPort[portNum].invoke(
        apid,
        sequenceCount
      );
    }
    ...
    Fw::Time SpacePacketFramerComponentBase ::
      getTime() const
    {
    ...
    {
      FW_ASSERT(callComp);
      SpacePacketFramerComponentBase* compPtr = static_cast<SpacePacketFramerComponentBase*>(callComp);
