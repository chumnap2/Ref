...
namespace Fw {
    ...
    serializeTo(Fw::SerializeBufferBase& buffer) const
  {
    ...
    status = buffer.serializeFrom(this->m_timeBase);
    if (status != Fw::FW_SERIALIZE_OK) {
      return status;
    }
    status = buffer.serializeFrom(this->m_timeContext);
    if (status != Fw::FW_SERIALIZE_OK) {
      return status;
    }
    ...
    deserializeFrom(Fw::SerializeBufferBase& buffer)
  {
    ...
    status = buffer.deserializeTo(this->m_timeBase);
    if (status != Fw::FW_SERIALIZE_OK) {
      return status;
    }
    status = buffer.deserializeTo(this->m_timeContext);
    if (status != Fw::FW_SERIALIZE_OK) {
      return status;
    }
