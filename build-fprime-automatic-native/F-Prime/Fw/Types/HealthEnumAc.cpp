// ======================================================================
// \title  HealthEnumAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for Health enum
// ======================================================================
...
namespace Fw {
  ...
  std::ostream& operator<<(std::ostream& os, const Health& obj) {
    Fw::String s;
    obj.toString(s);
    os << s;
    return os;
  ...
  bool Health ::
    isValid() const
  {
    return ((e >= HEALTHY) && (e <= FAILED));
  }

  Fw::SerializeStatus Health ::
