...
namespace Drv {
    ...
    invokeSerial(Fw::SerializeBufferBase& _buffer)
  {
    ...
    Fw::Buffer writeBuffer;
    _status = _buffer.deserializeTo(writeBuffer);
    if (_status != Fw::FW_SERIALIZE_OK) {
      return _status;
    }

    Fw::Buffer readBuffer;
    _status = _buffer.deserializeTo(readBuffer);
    if (_status != Fw::FW_SERIALIZE_OK) {
      return _status;
    }
    ...
    ) const
  {
    ...
    if (this->m_port != nullptr) {
      ...
      _status = _buffer.serializeFrom(writeBuffer);
      FW_ASSERT(_status == Fw::FW_SERIALIZE_OK, static_cast<FwAssertArgType>(_status));

      _status = _buffer.serializeFrom(readBuffer);
      FW_ASSERT(_status == Fw::FW_SERIALIZE_OK, static_cast<FwAssertArgType>(_status));
