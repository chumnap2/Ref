...
namespace Drv {
  ...
  FwIndexType TcpClientComponentBase ::
    getNum_recvReturnIn_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_recvReturnIn_InputPort));
  }
