// ======================================================================
// \title  ChoiceEnumAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for Choice enum
// ======================================================================
...
namespace Ref {
  ...
  std::ostream& operator<<(std::ostream& os, const Choice& obj) {
    Fw::String s;
    obj.toString(s);
    os << s;
    return os;
