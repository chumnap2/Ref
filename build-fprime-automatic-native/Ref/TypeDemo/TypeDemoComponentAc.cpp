...
namespace Ref {
    ...
    loadParameters()
  {
    ...
    _id = _baseId + PARAMID_CHOICE_PRM;
    ...
    if (this->m_param_CHOICE_PRM_valid == Fw::ParamValid::VALID) {
      _stat = _buff.deserializeTo(this->m_CHOICE_PRM);
    ...
    _id = _baseId + PARAMID_CHOICES_PRM;
    ...
    if (this->m_param_CHOICES_PRM_valid == Fw::ParamValid::VALID) {
      _stat = _buff.deserializeTo(this->m_CHOICES_PRM);
      if (_stat != Fw::FW_SERIALIZE_OK) {
    ...
    _id = _baseId + PARAMID_EXTRA_CHOICES_PRM;
    ...
    if (this->m_param_EXTRA_CHOICES_PRM_valid == Fw::ParamValid::VALID) {
      _stat = _buff.deserializeTo(this->m_EXTRA_CHOICES_PRM);
      if (_stat != Fw::FW_SERIALIZE_OK) {
    ...
    _id = _baseId + PARAMID_CHOICE_PAIR_PRM;
    ...
    if (this->m_param_CHOICE_PAIR_PRM_valid == Fw::ParamValid::VALID) {
      _stat = _buff.deserializeTo(this->m_CHOICE_PAIR_PRM);
      if (_stat != Fw::FW_SERIALIZE_OK) {
    ...
    _id = _baseId + PARAMID_GLUTTON_OF_CHOICE_PRM;
    ...
    if (this->m_param_GLUTTON_OF_CHOICE_PRM_valid == Fw::ParamValid::VALID) {
      _stat = _buff.deserializeTo(this->m_GLUTTON_OF_CHOICE_PRM);
      if (_stat != Fw::FW_SERIALIZE_OK) {
  ...
  FwIndexType TypeDemoComponentBase ::
    ...
    )
  {
    ...
    Ref::Choice choice;
    _status = args.deserializeTo(choice);
    ...
    )
  {
    ...
    _status = args.deserializeTo(choices);
    if (_status != Fw::FW_SERIALIZE_OK) {
      if (this->m_cmdResponseOut_OutputPort[0].isConnected()) {
        this->m_cmdResponseOut_OutputPort[0].invoke(
          opCode,
    ...
    )
  {
    ...
    U8 repeat;
    _status = args.deserializeTo(repeat);
    if (_status != Fw::FW_SERIALIZE_OK) {
      if (this->m_cmdResponseOut_OutputPort[0].isConnected()) {
        this->m_cmdResponseOut_OutputPort[0].invoke(
          opCode,
    ...
    U8 repeat_max;
    _status = args.deserializeTo(repeat_max);
    if (_status != Fw::FW_SERIALIZE_OK) {
      if (this->m_cmdResponseOut_OutputPort[0].isConnected()) {
        this->m_cmdResponseOut_OutputPort[0].invoke(
          opCode,
    ...
    )
  {
    ...
    _status = args.deserializeTo(scalar_input);
    if (_status != Fw::FW_SERIALIZE_OK) {
      if (this->m_cmdResponseOut_OutputPort[0].isConnected()) {
        this->m_cmdResponseOut_OutputPort[0].invoke(
          opCode,
  ...
  void TypeDemoComponentBase ::
    log_ACTIVITY_HI_ChoiceEv(Ref::Choice choice) const
  {
    // Get the time
    Fw::Time _logTime;
...
#endif
      _status = _logBuff.serializeFrom(choice);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
  ...
  void TypeDemoComponentBase ::
    log_ACTIVITY_HI_ChoicesEv(Ref::ManyChoices choices) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
...
#endif
      _status = _logBuff.serializeFrom(choices);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
  ...
  void TypeDemoComponentBase ::
    log_ACTIVITY_HI_ExtraChoicesEv(Ref::TooManyChoices choices) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void TypeDemoComponentBase ::
    log_ACTIVITY_HI_ChoicePairEv(Ref::ChoicePair choices) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void TypeDemoComponentBase ::
    log_ACTIVITY_HI_ChoiceSlurryEv(Ref::ChoiceSlurry choices) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
...
#endif
      _status = _logBuff.serializeFrom(validity);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
...
#endif
      _status = _logBuff.serializeFrom(float1);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
...
#endif
      _status = _logBuff.serializeFrom(float2);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
...
#endif
      _status = _logBuff.serializeFrom(float3);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
...
#endif
      _status = _logBuff.serializeFrom(floats);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
...
#endif
        "FloatEv ",
        static_cast<F64>(float1),
        static_cast<F64>(float2),
        static_cast<F64>(float3),
        floatsStr.toChar()
      );
  ...
  void TypeDemoComponentBase ::
    log_ACTIVITY_HI_ScalarStructEv(Ref::ScalarStruct scalar_argument) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
...
#endif
      _status = _logBuff.serializeFrom(scalar_argument);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
  ...
  void TypeDemoComponentBase ::
    tlmWrite_ScalarStructCh(
        const Ref::ScalarStruct& arg,
        Fw::Time _tlmTime
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARSTRUCTCH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARU8CH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARU16CH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARU32CH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARU64CH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARI8CH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARI16CH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARI32CH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARI64CH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARF32CH;
    ...
    ) const
  {
    if (this->m_tlmOut_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_SCALARF64CH;
    ...
    paramSet_EXTRA_CHOICES_PRM(Fw::SerializeBufferBase& val)
  {
    ...
    // Assign value only if successfully deserialized
    this->m_paramLock.lock();
    this->m_EXTRA_CHOICES_PRM = _localVal;
    ...
    paramSet_CHOICE_PAIR_PRM(Fw::SerializeBufferBase& val)
  {
    ...
    // Assign value only if successfully deserialized
    this->m_paramLock.lock();
    this->m_CHOICE_PAIR_PRM = _localVal;
    ...
    paramSet_GLUTTON_OF_CHOICE_PRM(Fw::SerializeBufferBase& val)
  {
    ...
    // Assign value only if successfully deserialized
    this->m_paramLock.lock();
    this->m_GLUTTON_OF_CHOICE_PRM = _localVal;
    ...
    paramSave_CHOICE_PRM()
  {
    ...
    if (this->m_prmSetOut_OutputPort[0].isConnected()) {
      ...
      _stat = _saveBuff.serializeFrom(m_CHOICE_PRM);
      ...
      _id = static_cast<FwPrmIdType>(this->getIdBase() + PARAMID_CHOICE_PRM);
    ...
    paramSave_CHOICES_PRM()
  {
    ...
    if (this->m_prmSetOut_OutputPort[0].isConnected()) {
      ...
      _stat = _saveBuff.serializeFrom(m_CHOICES_PRM);
      ...
      _id = static_cast<FwPrmIdType>(this->getIdBase() + PARAMID_CHOICES_PRM);
    ...
    paramSave_EXTRA_CHOICES_PRM()
  {
    ...
    if (this->m_prmSetOut_OutputPort[0].isConnected()) {
      ...
      _stat = _saveBuff.serializeFrom(m_EXTRA_CHOICES_PRM);
      ...
      _id = static_cast<FwPrmIdType>(this->getIdBase() + PARAMID_EXTRA_CHOICES_PRM);
    ...
    paramSave_CHOICE_PAIR_PRM()
  {
    ...
    if (this->m_prmSetOut_OutputPort[0].isConnected()) {
      ...
      _stat = _saveBuff.serializeFrom(m_CHOICE_PAIR_PRM);
      ...
      _id = static_cast<FwPrmIdType>(this->getIdBase() + PARAMID_CHOICE_PAIR_PRM);
    ...
    paramSave_GLUTTON_OF_CHOICE_PRM()
  {
    ...
    if (this->m_prmSetOut_OutputPort[0].isConnected()) {
      ...
      _stat = _saveBuff.serializeFrom(m_GLUTTON_OF_CHOICE_PRM);
      ...
      _id = static_cast<FwPrmIdType>(this->getIdBase() + PARAMID_GLUTTON_OF_CHOICE_PRM);
