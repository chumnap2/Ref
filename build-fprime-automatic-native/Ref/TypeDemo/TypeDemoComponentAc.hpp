...
namespace Ref {
    ...
    public Fw::PassiveComponentBase
  {
      ...
      friend class TypeDemoTesterBase;
      //! Friend class tester implementation to support white-box testing
      friend class TypeDemoTester;
    ...
    protected:
      ...
      enum {
        ...
        CHANNELID_SCALARSTRUCTCH = 0x9, //!< Channel ID for ScalarStructCh
        CHANNELID_SCALARU8CH = 0xa, //!< Channel ID for ScalarU8Ch
        CHANNELID_SCALARU16CH = 0xb, //!< Channel ID for ScalarU16Ch
        CHANNELID_SCALARU32CH = 0xc, //!< Channel ID for ScalarU32Ch
        CHANNELID_SCALARU64CH = 0xd, //!< Channel ID for ScalarU64Ch
        CHANNELID_SCALARI8CH = 0xe, //!< Channel ID for ScalarI8Ch
        CHANNELID_SCALARI16CH = 0xf, //!< Channel ID for ScalarI16Ch
        CHANNELID_SCALARI32CH = 0x10, //!< Channel ID for ScalarI32Ch
        CHANNELID_SCALARI64CH = 0x11, //!< Channel ID for ScalarI64Ch
        CHANNELID_SCALARF32CH = 0x12, //!< Channel ID for ScalarF32Ch
        CHANNELID_SCALARF64CH = 0x13, //!< Channel ID for ScalarF64Ch
      };
    ...
    protected:
      ...
      //!
      //! Single choice event
      void log_ACTIVITY_HI_ChoiceEv(Ref::Choice choice) const;

      //! Log event ChoicesEv
      //!
      //! Multiple choice event via Array
      void log_ACTIVITY_HI_ChoicesEv(Ref::ManyChoices choices) const;

      //! Log event ExtraChoicesEv
      //!
      //! Too many choice event via Array
      void log_ACTIVITY_HI_ExtraChoicesEv(Ref::TooManyChoices choices) const;

      //! Log event ChoicePairEv
      //!
      //! Multiple choice event via Structure
      void log_ACTIVITY_HI_ChoicePairEv(Ref::ChoicePair choices) const;

      //! Log event ChoiceSlurryEv
      //!
      //! Multiple choice event via Complex Structure
      void log_ACTIVITY_HI_ChoiceSlurryEv(Ref::ChoiceSlurry choices) const;
      ...
      void log_ACTIVITY_HI_ScalarStructEv(Ref::ScalarStruct scalar_argument) const;
    ...
    protected:
      ...
      //! Write telemetry channel ScalarStructCh
      //!
      //! Scalar struct channel
      void tlmWrite_ScalarStructCh(
          const Ref::ScalarStruct& arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarU8Ch
      //!
      //! Scalar U8 channel
      void tlmWrite_ScalarU8Ch(
          U8 arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarU16Ch
      //!
      //! Scalar U16 channel
      void tlmWrite_ScalarU16Ch(
          U16 arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarU32Ch
      //!
      //! Scalar U32 channel
      void tlmWrite_ScalarU32Ch(
          U32 arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarU64Ch
      //!
      //! Scalar U64 channel
      void tlmWrite_ScalarU64Ch(
          U64 arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarI8Ch
      //!
      //! Scalar I8 channel
      void tlmWrite_ScalarI8Ch(
          I8 arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarI16Ch
      //!
      //! Scalar I16 channel
      void tlmWrite_ScalarI16Ch(
          I16 arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarI32Ch
      //!
      //! Scalar I32 channel
      void tlmWrite_ScalarI32Ch(
          I32 arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarI64Ch
      //!
      //! Scalar I64 channel
      void tlmWrite_ScalarI64Ch(
          I64 arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarF32Ch
      //!
      //! Scalar F32 channel
      void tlmWrite_ScalarF32Ch(
          F32 arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;

      //! Write telemetry channel ScalarF64Ch
      //!
      //! Scalar F64 channel
      void tlmWrite_ScalarF64Ch(
