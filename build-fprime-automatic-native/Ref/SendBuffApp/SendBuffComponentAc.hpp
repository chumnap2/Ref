...
#ifndef Ref_SendBuffComponentAc_HPP
#define Ref_SendBuffComponentAc_HPP

#include <atomic>

#include "Drv/Ports/DataTypes/DataBufferPortAc.hpp"
...
namespace Ref {
    ...
    public Fw::QueuedComponentBase
  {
      ...
      friend class SendBuffTesterBase;
      //! Friend class tester implementation to support white-box testing
      friend class SendBuffTester;
    ...
    protected:
      ...
      //! Command opcodes
      enum {
        OPCODE_SB_START_PKTS = 0x0, //!< Command to start sending packets
        OPCODE_SB_INJECT_PKT_ERROR = 0x1, //!< Send a bad packet
        OPCODE_SB_GEN_FATAL = 0x2, //!< Generate a FATAL EVR
        OPCODE_SB_GEN_ASSERT = 0x3, //!< Generate an ASSERT
        OPCODE_PARAMETER3_SET = 0xa, //!< Opcode to set parameter parameter3
        OPCODE_PARAMETER3_SAVE = 0xb, //!< Opcode to save parameter parameter3
        OPCODE_PARAMETER4_SET = 0xc, //!< Opcode to set parameter parameter4
        OPCODE_PARAMETER4_SAVE = 0xd, //!< Opcode to save parameter parameter4
      };

      //! Event IDs
      enum {
        EVENTID_FIRSTPACKETSENT = 0x0, //!< First packet send
        EVENTID_PACKETERRORINSERTED = 0x1, //!< Packet checksum error
        EVENTID_BUFFSENDPARAMETERUPDATED = 0x2, //!< Report parameter update
        EVENTID_SENDBUFFFATAL = 0x3, //!< A test FATAL
      };

      //! Channel IDs
      enum {
        CHANNELID_PACKETSSENT = 0x0, //!< Channel ID for PacketsSent
        CHANNELID_NUMERRORSINJECTED = 0x1, //!< Channel ID for NumErrorsInjected
        CHANNELID_PARAMETER3 = 0x2, //!< Channel ID for Parameter3
        CHANNELID_PARAMETER4 = 0x3, //!< Channel ID for Parameter4
        CHANNELID_SENDSTATE = 0x4, //!< Channel ID for SendState
      };

      //! Parameter IDs
      enum {
        PARAMID_PARAMETER3 = 0x0, //!< A test parameter
        PARAMID_PARAMETER4 = 0x1, //!< A test parameter
      };
    ...
    public:
      ...
      //! Initialize SendBuffComponentBase object
      void init(
    ...
    protected:
      ...
      //! Construct SendBuffComponentBase object
      SendBuffComponentBase(
          const char* compName = "" //!< The component name
      );

      //! Destroy SendBuffComponentBase object
      virtual ~SendBuffComponentBase();
    ...
    protected:
      ...
      FwIndexType getNum_ParamGet_OutputPorts() const;

      //! Get the number of ParamSet output ports
      //!
      //! \return The number of ParamSet output ports
      FwIndexType getNum_ParamSet_OutputPorts() const;
    ...
    protected:
      ...
      FwIndexType getNum_Data_OutputPorts() const;
    ...
    protected:
      ...
      void tlmWrite_SendState(
          const Ref::SendBuff_ActiveState& arg, //!< The telemetry value
          Fw::Time _tlmTime = Fw::Time() //!< Timestamp. Default: unspecified, request from getTime port
      ) const;
    ...
    private:
      ...
      Fw::CmdResponse paramSet_parameter3(
      ...
      //!
      //! \return The command response
      Fw::CmdResponse paramSet_parameter4(
          Fw::SerializeBufferBase& val //!< The serialization buffer
      );
    ...
    private:
      ...
      //!
      //! \return The command response
      Fw::CmdResponse paramSave_parameter3();

      //! Save parameter parameter4
      //!
      //! \return The command response
      Fw::CmdResponse paramSave_parameter4();
    ...
    private:
      ...
      //! True if parameter3 was successfully received
      Fw::ParamValid m_param_parameter3_valid;

      //! True if parameter4 was successfully received
